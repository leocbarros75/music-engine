...
function suzukiParams(volume: number, instrument: "violin" | "viola" | "cello" | "bass"): SuzukiParams {
  ...
  // Ranges derived from Suzuki Violin Vol. 4 & 5 and Viola Vol. 4 & 5 scores.
  // Violin Vol. 4: Seitz Student Concerto No. 5, Vivaldi Concerto in A minor,
  //   Bach Double Concerto, Handel Sonata movements. Structural 16th semiquaver
  //   runs dominate fast movements; dotted 8th+16th is the defining Baroque concerto
  //   cell; triplet-8th figures common. Active 4th–5th position; violin tops E6 (88).
  // Violin Vol. 5: Bach BWV 1041 (all movements), Vivaldi-style, Handel Sonata.
  //   Continuous semiquaver runs; 5th–6th position; violin tops G6 (91).
  // Viola Vol. 4: Seitz No. 2 & No. 5, Vivaldi D minor (from A minor), Telemann
  //   G Major concertos. 4th Position etude explicitly introduced (page 17). In 4th
  //   position, 4th finger on A string reaches C6 (MIDI 84); ceiling confirmed by
  //   Vivaldi/Seitz runs and treble-clef passages peaking at C6.
  // Viola Vol. 5: Marcello Sonata, Weber Country Dance, Rubinstein Spinning Wheel,
  //   Veracini Gigue, Bach Cello Suite I (Prelude/Courante/Gigue), Bohm Moto
  //   Perpetuo, Marais Four French Dances, JC Bach Concerto in C minor. 5th Position
  ...
  // Ranges derived from Suzuki Violin Vol. 6 and Viola Vol. 6 scores.
  // Violin Vol. 6: Bach BWV 1042 (E major concerto, all movements), Handel Sonata.
  //   6th–7th position passages; violin tops A6 (MIDI 93); approach density maximum.
  // Viola Vol. 6: La Folia (Marais, 6 variations), Allegro (Fiocco), Suite in G
  //   Major (Bach), Arioso (Bach), Adagio & Rondo in D (Mozart K356/K485), Hungarian
  //   Dance No. 5 (Brahms), Concerto for Two Violins (Bach, Violin II for viola),
  //   Concerto in B minor (Handel/Casadesus, all 3 movements).
  //   6th AND 7th Position etudes explicitly introduced (page 24). In 7th position,
  //   4th finger on A string reaches E6 (MIDI 88); this is the practical repertoire
  //   ceiling confirmed by: the 3-octave D major scale exercise reaching D6 (86);
  //   La Folia VAR VI arpeggios and Fiocco Allegro runs peaking at E6 (88); Handel
  //   Concerto B minor movements I–III which push continuously into 6th–7th position.
  //   G6 (91) was the prior estimate but requires positions beyond 7th — not
